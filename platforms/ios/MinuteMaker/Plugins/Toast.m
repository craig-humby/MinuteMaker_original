...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Toast-PhoneGap-Plugin/src/ios/Toast.m at a3a1ec7de8e5170ad952207381e523ab770d37f2 · EddyVerbruggen/Toast-PhoneGap-Plugin</title>
...
<meta content="R2ucgxrSFqajbnY1XntdPkCxfOHpXie75VY6g9zqwZ8=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-13805a78bc89e6b8baa64d96ee8bef168f18cedb.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="658648d282bcc2be3e05884ea04fd5df">
        ...
        <link data-pjax-transient rel='permalink' href='/EddyVerbruggen/Toast-PhoneGap-Plugin/blob/a3a1ec7de8e5170ad952207381e523ab770d37f2/src/ios/Toast.m'>
...
<!-- blob contrib key: blob_contributors:v21:2d683ed98424fe27fd57d18b64d48bac -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/EddyVerbruggen/Toast-PhoneGap-Plugin/blob/master/src/ios/Toast.m"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
    ...
    <div class="meta">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/EddyVerbruggen/Toast-PhoneGap-Plugin/raw/a3a1ec7de8e5170ad952207381e523ab770d37f2/src/ios/Toast.m" class="button minibutton " id="raw-url">Raw</a>
            <a href="/EddyVerbruggen/Toast-PhoneGap-Plugin/blame/a3a1ec7de8e5170ad952207381e523ab770d37f2/src/ios/Toast.m" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/EddyVerbruggen/Toast-PhoneGap-Plugin/commits/a3a1ec7de8e5170ad952207381e523ab770d37f2/src/ios/Toast.m" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L36" rel="#L36">36</span>
            ...
            <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="cp">#import &quot;Toast.h&quot;</span></div><div class='line' id='LC2'><span class="cp">#import &quot;Toast+UIView.h&quot;</span></div><div class='line' id='LC3'><span class="cp">#import &lt;Cordova/CDV.h&gt;</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'><span class="k">@implementation</span> <span class="nc">Toast</span></div><div class='line' id='LC6'><br/></div><div class='line' id='LC7'><span class="k">-</span> <span class="p">(</span><span class="kt">void</span><span class="p">)</span><span class="nf">show:</span><span class="p">(</span><span class="n">CDVInvokedUrlCommand</span><span class="o">*</span><span class="p">)</span><span class="nv">command</span> <span class="p">{</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'>&nbsp;&nbsp;<span class="n">NSString</span> <span class="o">*</span><span class="n">message</span>  <span class="o">=</span> <span class="p">[</span><span class="n">command</span><span class="p">.</span><span class="n">arguments</span> <span class="n">objectAtIndex</span><span class="o">:</span><span class="mi">0</span><span class="p">];</span></div><div class='line' id='LC10'>&nbsp;&nbsp;<span class="n">NSString</span> <span class="o">*</span><span class="n">duration</span> <span class="o">=</span> <span class="p">[</span><span class="n">command</span><span class="p">.</span><span class="n">arguments</span> <span class="n">objectAtIndex</span><span class="o">:</span><span class="mi">1</span><span class="p">];</span></div><div class='line' id='LC11'>&nbsp;&nbsp;<span class="n">NSString</span> <span class="o">*</span><span class="n">position</span> <span class="o">=</span> <span class="p">[</span><span class="n">command</span><span class="p">.</span><span class="n">arguments</span> <span class="n">objectAtIndex</span><span class="o">:</span><span class="mi">2</span><span class="p">];</span></div><div class='line' id='LC12'><br/></div><div class='line' id='LC13'>&nbsp;&nbsp;<span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="p">[</span><span class="n">position</span> <span class="n">isEqual</span><span class="o">:</span> <span class="s">@&quot;top&quot;</span><span class="p">]</span> <span class="o">&amp;&amp;</span> <span class="o">!</span><span class="p">[</span><span class="n">position</span> <span class="n">isEqual</span><span class="o">:</span> <span class="s">@&quot;center&quot;</span><span class="p">]</span> <span class="o">&amp;&amp;</span> <span class="o">!</span><span class="p">[</span><span class="n">position</span> <span class="n">isEqual</span><span class="o">:</span> <span class="s">@&quot;bottom&quot;</span><span class="p">])</span> <span class="p">{</span></div><div class='line' id='LC14'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">CDVPluginResult</span> <span class="o">*</span> <span class="n">pluginResult</span> <span class="o">=</span> <span class="p">[</span><span class="n">CDVPluginResult</span> <span class="n">resultWithStatus</span><span class="o">:</span><span class="n">CDVCommandStatus_ERROR</span> <span class="n">messageAsString</span><span class="o">:</span><span class="s">@&quot;invalid position. valid options are &#39;top&#39;, &#39;center&#39; and &#39;bottom&#39;&quot;</span><span class="p">];</span></div><div class='line' id='LC15'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">[</span><span class="n">self</span> <span class="n">writeJavascript</span><span class="o">:</span><span class="p">[</span><span class="n">pluginResult</span> <span class="n">toErrorCallbackString</span><span class="o">:</span><span class="n">command</span><span class="p">.</span><span class="n">callbackId</span><span class="p">]];</span></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span><span class="p">;</span></div><div class='line' id='LC17'>&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC18'><br/></div><div class='line' id='LC19'>&nbsp;&nbsp;<span class="n">NSInteger</span> <span class="n">durationInt</span><span class="p">;</span></div><div class='line' id='LC20'>&nbsp;&nbsp;<span class="k">if</span> <span class="p">([</span><span class="n">duration</span> <span class="n">isEqual</span><span class="o">:</span> <span class="s">@&quot;short&quot;</span><span class="p">])</span> <span class="p">{</span></div><div class='line' id='LC21'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">durationInt</span> <span class="o">=</span> <span class="mi">2</span><span class="p">;</span></div><div class='line' id='LC22'>&nbsp;&nbsp;<span class="p">}</span> <span class="k">else</span> <span class="k">if</span> <span class="p">([</span><span class="n">duration</span> <span class="n">isEqual</span><span class="o">:</span> <span class="s">@&quot;long&quot;</span><span class="p">])</span> <span class="p">{</span></div><div class='line' id='LC23'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">durationInt</span> <span class="o">=</span> <span class="mi">5</span><span class="p">;</span></div><div class='line' id='LC24'>&nbsp;&nbsp;<span class="p">}</span> <span class="k">else</span> <span class="p">{</span></div><div class='line' id='LC25'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">CDVPluginResult</span> <span class="o">*</span> <span class="n">pluginResult</span> <span class="o">=</span> <span class="p">[</span><span class="n">CDVPluginResult</span> <span class="n">resultWithStatus</span><span class="o">:</span><span class="n">CDVCommandStatus_ERROR</span> <span class="n">messageAsString</span><span class="o">:</span><span class="s">@&quot;invalid duration. valid options are &#39;short&#39; and &#39;long&#39;&quot;</span><span class="p">];</span></div><div class='line' id='LC26'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">[</span><span class="n">self</span> <span class="n">writeJavascript</span><span class="o">:</span><span class="p">[</span><span class="n">pluginResult</span> <span class="n">toErrorCallbackString</span><span class="o">:</span><span class="n">command</span><span class="p">.</span><span class="n">callbackId</span><span class="p">]];</span></div><div class='line' id='LC27'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span><span class="p">;</span></div><div class='line' id='LC28'>&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC29'><br/></div><div class='line' id='LC30'>&nbsp;&nbsp;<span class="p">[</span><span class="n">self</span><span class="p">.</span><span class="n">webView</span> <span class="n">makeToast</span><span class="o">:</span><span class="n">message</span> <span class="n">duration</span><span class="o">:</span><span class="n">durationInt</span> <span class="n">position</span><span class="o">:</span><span class="n">position</span><span class="p">];</span></div><div class='line' id='LC31'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC32'>&nbsp;&nbsp;<span class="n">CDVPluginResult</span><span class="o">*</span> <span class="n">pluginResult</span> <span class="o">=</span> <span class="p">[</span><span class="n">CDVPluginResult</span> <span class="n">resultWithStatus</span><span class="o">:</span><span class="n">CDVCommandStatus_OK</span><span class="p">];</span></div><div class='line' id='LC33'>&nbsp;&nbsp;<span class="p">[</span><span class="n">self</span> <span class="n">writeJavascript</span><span class="o">:</span><span class="p">[</span><span class="n">pluginResult</span> <span class="n">toSuccessCallbackString</span><span class="o">:</span><span class="n">command</span><span class="p">.</span><span class="n">callbackId</span><span class="p">]];</span></div><div class='line' id='LC34'><span class="p">}</span></div><div class='line' id='LC35'><br/></div><div class='line' id='LC36'><span class="k">@end</span></div></pre></div></td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.06670s from github-fe119-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
